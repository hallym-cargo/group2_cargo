...
export default function AdminNoticesTab({ controller }) {
  const { noticeForm, setNoticeForm, submitNotice, editingNoticeId, setEditingNoticeId, adminNotices, deleteAdminNotice, loadAdmin, loadPublic } = controller
  return (
